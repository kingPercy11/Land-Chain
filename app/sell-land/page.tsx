...
import { UserCircle2, DollarSign, TrendingUp } from 'lucide-react'

// Mock data for registered lands
const registeredLands = [
  { id: '1', address: '123 Main St, City A', area: 1000, location: 'City A' },
  { id: '2', address: '456 Oak Ave, City B', area: 1500, location: 'City B' },
  { id: '3', address: '789 Pine Rd, City C', area: 2000, location: 'City C' },
]
...
function SellLandComponent() {
  ...
  const handleAIPrediction = () => {
    ...
    setTimeout(() => {
      const predictedPrice = Math.floor(Math.random() * (1000000 - 500000) + 500000);
          ...
          <CardContent>
            <form className="space-y-8">
              ...
              <Button type="submit" className="w-full">
                <DollarSign className="mr-2 h-4 w-4" /> Upload Listing
              </Button>
            </form>
          </CardContent>
        </Card>
